...
export const Icons = {
    ...
    MapPin: (p:any) => <Icon {...p}><path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z"/><circle cx="12" cy="10" r="3"/></Icon>,
    ...
    BarChart: (p:any) => <Icon {...p}><line x1="12" y1="20" x2="12" y2="10"/><line x1="18" y1="20" x2="18" y2="4"/><line x1="6" y1="20" x2="6" y2="16"/></Icon>,
    ...
    AlertCircle: (p:any) => <Icon {...p}><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></Icon>,
    ...
    Briefcase: (p:any) => <Icon {...p}><rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/></Icon>,
    Wifi: (p:any) => <Icon {...p}><path d="M5 13a10 10 0 0 1 14 0"/><path d="M8.5 16.5a5 5 0 0 1 7 0"/><path d="M12 19h.01"/></Icon>,
    WifiOff: (p:any) => <Icon {...p}><path d="M1 1l22 22"/><path d="M16.72 11.06A10.94 10.94 0 0 1 19 13"/><path d="M5 13a10.94 10.94 0 0 1 2.28-1.94"/><path d="M10.71 5.05A16 16 0 0 1 22.58 9"/><path d="M1.42 9a16 16 0 0 1 4.7-2.81"/><path d="M8.5 16.5a5 5 0 0 1 7 0"/><path d="M12 19h.01"/></Icon>,
    Database: (p:any) => <Icon {...p}><ellipse cx="12" cy="5" rx="9" ry="3"/><path d="M3 5V19A9 3 0 0 0 21 19V5"/><path d="M3 12A9 3 0 0 0 21 12"/></Icon>,
    CloudOff: (p:any) => <Icon {...p}><path d="m2 2 20 20"/><path d="M5.782 5.782A7 7 0 0 0 9 19h8.5a4.5 4.5 0 0 0 1.307-.193"/><path d="M22.588 16.713A4.5 4.5 0 0 0 18 9h-1.26A8 8 0 0 0 7.02 5.01"/></Icon>,
    RefreshCw: (p:any) => <Icon {...p}><path d="M3 12a9 9 0 0 1 9-9 9.75 9.75 0 0 1 6.74 2.74L21 8"/><path d="M21 3v5h-5"/><path d="M21 12a9 9 0 0 1-9 9 9.75 9.75 0 0 1-6.74-2.74L3 16"/><path d="M3 21v-5h5"/></Icon>,
    Eye: (p:any) => <Icon {...p}><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></Icon>,
    ...
    Baby: (p:any) => <Icon {...p}><path d="M9 12h.01"/><path d="M15 12h.01"/><path d="M10 16c.5.3 1.2.5 2 .5s1.5-.2 2-.5"/><path d="M19 6.3a9 9 0 0 1 1.8 3.9 2 2 0 0 1 0 3.6 9 9 0 0 1-17.6 0 2 2 0 0 1 0-3.6A9 9 0 0 1 5 6.3"/><path d="M12 2a5 5 0 0 1 5 5v1"/><path d="M12 2a5 5 0 0 0-5 5v1"/><path d="M12 8a1 1 0 1 1 0-2 1 1 0 0 1 0 2Z"/></Icon>,
